...
function setup() {
  ...
  // movingBox.debug = true;
    ...
    collideObj1 = createSprite(350, 100, 100, 50);
    collideObj1.velocityX = 4;
  
    collideObj2 = createSprite(550, 100, 100, 50);
    collideObj2.shapeColor = "blue";
}

function draw() {
  background(255, 255, 255);
  
    collide(collideObj1, collideObj2);
  
    textSize(17);
    text("MouseX: " + mouseX, 150, 300);
    text("MouseY: " + mouseY, 350, 300);
  // movingBox.x = mouseX;
  // movingBox.y = mouseY;
